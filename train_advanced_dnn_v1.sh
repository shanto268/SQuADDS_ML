#!/bin/bash
#SBATCH --job-name=train_advanced_dnn_v1
#SBATCH --output=train_advanced_dnn_v1%j.log
#SBATCH --error=train_advanced_dnn_v1%j.err
...
srun python train_advanced_dnn_v1.py
