...
def save_progress(df, index):
    df.to_csv("train_quarter_wave_dataset_wip.csv", index=False)
    df.to_parquet("train_quarter_wave_dataset_wip.parquet", index=False)
...
# Save the final results
combined_merged_df.to_csv("train_quarter_wave_dataset_full.csv", index=False)
combined_merged_df.to_parquet("train_quarter_wave_dataset_full.parquet", index=False)
